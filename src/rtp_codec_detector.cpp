...
VideoCodec RtpCodecDecoder::detect_codec(int socket_fd)
{
    ...
    // TODO: need to add syncronisation maybe std::atomic<int> running -> while (running && detected_codec == CODEC_UNKNOWN) {
    while (detected_codec == VideoCodec::UNKNOWN) {
