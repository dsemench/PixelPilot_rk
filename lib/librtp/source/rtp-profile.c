...
static struct rtp_profile_t s_profiles[] = {
    ...
    { 96, RTP_TYPE_VIDEO, 0, 90000, "H265" }, // Draft RFC — HEVC (dynamic PT)
    { 100, RTP_TYPE_VIDEO, 0, 90000, "VP8" },    // draft-ietf-payload-vp8
    { 101, RTP_TYPE_VIDEO, 0, 90000, "VP9" },    // unofficial
    { 102, RTP_TYPE_VIDEO, 0, 90000, "H265" },    // unofficial
